...
class Place(TimeStampedModel):
    ...
    city = models.CharField(max_length=255, verbose_name=gettext_lazy('cidade'))
    state_province = models.CharField(max_length=255, null=True, verbose_name=gettext_lazy('estado/província'))
    country = models.CharField(max_length=255, verbose_name=gettext_lazy('país'))
...
class Publisher(TimeStampedModel):
    ...
    place = models.ForeignKey(Place, null=True, on_delete=models.RESTRICT, related_name=gettext_lazy('local'))
...
class OriginalFragment(TimeStampedModel):
    ...
    work = models.ForeignKey(Work, on_delete=models.RESTRICT, related_name=gettext_lazy('obra'))
...
class TranslatedFragment(TimeStampedModel):
    ...
    work = models.ForeignKey(Translation, on_delete=models.RESTRICT, related_name=gettext_lazy('tradução'))
    fragment = models.TextField(verbose_name=gettext_lazy('fragmento'))
    original = models.ForeignKey(OriginalFragment, on_delete=models.RESTRICT, related_name=gettext_lazy('original'))
